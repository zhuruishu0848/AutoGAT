...
with open("./p300/wiki/"+'glove.6B.' + str(word_embeddings_dim) + 'd.txt', 'r',encoding='utf-8') as f:
...
def build_graph(start, end):
    ...
    for i in tqdm(range(start, end)):
        ...
        for key in word_pair_count:
            p = key[0]
            q = key[1]
            row.append(doc_word_id_map[vocab[p]]) # p
            col.append(doc_word_id_map[vocab[q]]) # q
